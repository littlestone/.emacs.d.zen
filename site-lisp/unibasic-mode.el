...
(defcustom unibasic-mode-hook ()
  ...
  :type 'hook
  :group 'unibasic)
(defcustom unibasic-initial-indent 3
  "*The value for the initial indentation of unibasic statements. This gives
a bit of room for labels. The default value is 3."
  :type 'integer
  :group 'unibasic)
(defcustom unibasic-default-indent 3
  ...
  :type 'integer
  :group 'unibasic)
(defcustom unibasic-case-indent 0
  "*Indentation offset for unibasic case statements within the case block."
  :type 'integer
  :group 'unibasic)
(defcustom unibasic-continuation-indent -3
